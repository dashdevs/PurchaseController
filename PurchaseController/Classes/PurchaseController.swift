...
public final class PurchaseController: PaymentQueueObserver, ProductsInfoObserver, ReceiptFetcherObserver {
    ...
    /*Storage object. storage.receipt vailadble ONLY after validateReceipt(using validator:) call.*/
    ...
    lazy var onRestoreRequested: (() -> Void)? = { [weak self] in
        self?.purchaseActionState = .finish(PurchaseActionResult.restoreRequested)
    }
