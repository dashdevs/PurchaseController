...
enum SectionTableItemModel: String {
    ...
    private var actionSection: [TableItemModel] { return [.retrieve, .restore, .validateReceiptLocally, .validateReceiptRemotely, .refreshReceipt, .validateSubscription, .manageSubscriptions] }
